...
from models.autoencoder import AutoencoderKL, IdentityFirstStage
from models.ddim import DDIMSampler
from modules.ema import LitEma
from modules.diffusionmodules.util import make_beta_schedule, extract_into_tensor, noise_like, mean_flat
...
class DiffusionWrapper(pl.LightningModule):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None, c_adm=None, c_pose = None):
        if self.conditioning_key is None:
            ...
            if hasattr(self, "scripted_diffusion_model"):
                ...
                out = self.diffusion_model(x, t, context=cc, pose=c_pose)
        elif self.conditioning_key == 'hybrid':
            xc = torch.cat([x] + c_concat, dim=1)
            cc = torch.cat(c_crossattn, 1)
            out = self.diffusion_model(xc, t, context=cc, pose=c_pose)
